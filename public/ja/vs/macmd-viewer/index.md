...
| インターフェイスの言語 | 公式の資料に記載なし | 英語、繁体字中国語、簡体字中国語、日本語、ドイツ語、フランス語、スペイン語、韓国語 |
...
MarsDawn は Mac App Store で配信中です。無料の `marsdawn` コマンドラインツールも、どんな Markdown ファイルも Mermaid 図とハイライトされたコード付きの PDF にレンダリングでき、他に何もインストールする必要はありません。
