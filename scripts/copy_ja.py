...
def build(k) -> dict:
    ...
    schema_notes = {'export': 'export 成功時', 'open': 'open 成功時、marsdawn 0.5.1 以降', 'open_v2': 'open 成功時、marsdawn 0.3.0〜0.5.0', 'error': '失敗時、両方のコマンド共通', 'open_v1': 'open 成功時、marsdawn 0.2.x（<code>opened</code> がパスのリストだった頃）'}
