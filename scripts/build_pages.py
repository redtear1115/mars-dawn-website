...
# sentence changes in every language at once. The launch ships four UI languages (app #104); whether
# these pages should say so is waiting on the owner (website #41), so for now they say what the
# approved en and zh-Hant copy says.
APP_UI_LANGUAGES = {
...
def _merge_locale(locale: str, module) -> None:
    ...
    assert set(t["pages"]) == set(PAGE_ORDER), f"{locale}: pages differ from PAGE_ORDER"
