...
def build(k) -> dict:
    ...
    schema_notes = {'export': 'export 成功時', 'open': 'open 成功時、marsdawn 0.5.1 以降', 'open_v2': 'open 成功時、marsdawn 0.3.0〜0.5.0', 'error': '失敗時、両方のコマンド共通、marsdawn 0.5.2 以降', 'open_v1': 'open 成功時、marsdawn 0.2.x（<code>opened</code> がパスのリストだった頃）', 'error_v1': '失敗時、両方のコマンド共通、marsdawn 0.5.1 以前'}
...
<p>行の指定は marsdawn 0.3.0 で、<code>--background</code> は 0.5.1 で追加されました。</p>
...
<ul>
  ...
  <li><code>--background</code> は marsdawn 0.5.1 で追加されました。</li>
</ul>
<p>成功、終了コード 0：</p>
