...
- 這份指南自己的 workflow 模式，更深入的一篇：[Anthropic 把 workflow 和 agent 分開來看，你的閱讀落在哪一邊？](/zh-hant/reading-notes/anthropic-building-effective-agents/)
- Harrison Chase 對可觀測性的主張，更深入的一篇：[Harrison Chase 的 agentic 光譜：愈自主，愈需要盯著看](/zh-hant/reading-notes/harrison-chase-what-is-an-agent/)
