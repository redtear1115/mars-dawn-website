...
- Chip Huyen's read-only/write-action split, read closer: [Chip Huyen's read-only/write-action split, and why it matters before you approve anything](/reading-notes/chip-huyen-agents/)
- Andrew Ng's own ranking of his design patterns, read closer: [Andrew Ng ranks his own design patterns by how predictable they are](/reading-notes/andrew-ng-design-patterns/)
