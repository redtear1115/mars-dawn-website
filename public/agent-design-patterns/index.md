...
- Andrew Ng's own ranking of these patterns, read closer: [Andrew Ng ranks his own design patterns by how predictable they are](/reading-notes/andrew-ng-design-patterns/)
- Lilian Weng's earlier blueprint for an agent, read closer: [Lilian Weng's 2023 blueprint for an agent, and the file each part leaves behind](/reading-notes/lilian-weng-llm-agents/)
