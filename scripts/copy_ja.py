...
<ul>
  ...
  <li><strong>どこへ送られるか。</strong>これらのイベントは、このサイト自身のサーバーから PostHog（{{{{POSTHOG_REGION}}}} リージョン）へ送られます。ブラウザが PostHog に接続することはありません。PostHog の保持期間は {{{{RETENTION}}}} です。完全な IP アドレスは転送しません。</li>
