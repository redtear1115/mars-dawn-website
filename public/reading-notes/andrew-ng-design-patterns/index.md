# Andrew Ng ranks his own design patterns by how predictable they are

**Across five letters in The Batch in early 2024, Andrew Ng described four agentic design patterns — reflection, tool use, planning and multi-agent collaboration — and, unusually, told his readers straight out which he finds more reliable and which he finds hard to predict.**

## What the letters argue

`/agent-design-patterns/` already covers what each of the four patterns is, what each tends to hand you to read as our own inference, and Ng's own verdict on planning, quoted from Part 4: “while I can get the agentic design patterns of Reflection and Tool Use to work reliably and improve my applications’ performance, Planning is a less mature technology, and I find it hard to predict in advance what it will do.” What this note adds is the same ranking from the two letters that page leaves out: Part 3, written one week before Part 4, where he states the ranking in advance, and Part 5, where he extends it to cover the pattern Part 4 doesn't mention — multi-agent collaboration. Introducing tool use, in Part 3, he writes:
...
Two weeks later, closing out the series with multi-agent collaboration, he confirms the same ranking from the other side:
...
- What each pattern tends to hand you, in full: [Four agent design patterns and the documents each one hands you](/agent-design-patterns/)
...
- Andrew Ng, “Agentic Design Patterns Part 3: Tool Use,” The Batch, April 3, 2024: [https://www.deeplearning.ai/the-batch/agentic-design-patterns-part-3-tool-use/](https://www.deeplearning.ai/the-batch/agentic-design-patterns-part-3-tool-use/) (fetched and quoted 2026-09-26).
- Andrew Ng, “Agentic Design Patterns Part 4: Planning,” The Batch, April 10, 2024: [https://www.deeplearning.ai/the-batch/agentic-design-patterns-part-4-planning/](https://www.deeplearning.ai/the-batch/agentic-design-patterns-part-4-planning/) (quote reused verbatim from `design/inbox/276-agent-blog-series.md`, already quoted on `/agent-design-patterns/`).
- Andrew Ng, “Agentic Design Patterns Part 5, Multi-Agent Collaboration,” The Batch, April 17, 2024: [https://www.deeplearning.ai/the-batch/agentic-design-patterns-part-5-multi-agent-collaboration/](https://www.deeplearning.ai/the-batch/agentic-design-patterns-part-5-multi-agent-collaboration/) (fetched and quoted 2026-09-26).
