...
- Chip Huyen の read-only／write action という分け方を、より詳しく：[Chip Huyen の read-only／write action という分け方、承認する前になぜ大事か](/ja/reading-notes/chip-huyen-agents/)
- Andrew Ng が自分の設計パターンをどうランク付けしているか、より詳しく：[Andrew Ng が自分の設計パターンを予測可能性で自らランク付けする](/ja/reading-notes/andrew-ng-design-patterns/)
