...
- This guide's own workflow patterns, read closer: [Anthropic draws a line between workflows and agents. Where does your reading fit?](/reading-notes/anthropic-building-effective-agents/)
- Harrison Chase's case for observability, read closer: [Harrison Chase's spectrum: the more agentic it is, the more you'll want to watch it](/reading-notes/harrison-chase-what-is-an-agent/)
