...
.loop-term {
  ...
  --term-x: 450u; --term-y: -235u; --term-s: 1.3;
...
/* The reply lands once both of the agent's edits have (60%, and 60% plus .45s). */
@keyframes loop-l3 { 0%, 65% { opacity: 0; transform: translateY(8u); } 68%, 88% { opacity: 1; transform: none; } 91%, 100% { opacity: 0; transform: none; } }
...
@media (max-width: 560px) {
  ...
  .loop-stage { --u: calc(100cqw / 460); top: -50u; }
  .loop-term { left: 640u; top: 540u; width: 440u; height: 240u; --term-x: 0u; --term-y: -190u; --term-s: 1; }
}
