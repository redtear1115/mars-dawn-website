...
@keyframes loop-l3 { 0%, 68% { opacity: 0; transform: translateY(8u); } 71%, 88% { opacity: 1; transform: none; } 91%, 100% { opacity: 0; transform: none; } }
...
@media (max-width: 820px) {
  ...
  .loop-term { left: 650u; top: 540u; height: 290u; --term-x: 130u; --term-y: -205u; }
