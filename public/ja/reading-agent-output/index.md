...
MarsDawn は [Mac App Store](https://apps.apple.com/app/id6812925073) で配信中です。無料の `marsdawn` コマンドラインツールもあります：

```
brew install redtear1115/tap/marsdawn
```

アプリなしで Markdown を PDF に書き出せます。`marsdawn open` でエージェントにファイルを MarsDawn で開かせることもできます。
