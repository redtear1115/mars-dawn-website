...
- **文件很长：**“显示 ▸ 显示边栏”（⌃⌘S）打开“大纲”标签页，列出所有标题，点一下就跳过去。
...
- 这份指南自己的 workflow 模式，更深入的一篇：[Anthropic 把 workflow 和 agent 分开来看，你的阅读落在哪一边？](/zh-hans/reading-notes/anthropic-building-effective-agents/)
- Harrison Chase 对可观测性的主张，更深入的一篇：[Harrison Chase 的 agentic 光谱：愈自主，愈需要盯着看](/zh-hans/reading-notes/harrison-chase-what-is-an-agent/)
