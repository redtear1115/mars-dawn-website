...
def build(k) -> dict:
    ...
    schema_notes = {'export': 'export 成功', 'open': 'open 成功，marsdawn 0.5.1 以后', 'open_v2': 'open 成功，marsdawn 0.3.0 到 0.5.0', 'error': '两个命令的失败结果，marsdawn 0.5.2 以后', 'open_v1': 'open 成功，marsdawn 0.2.x，当时 <code>opened</code> 是路径清单', 'error_v1': '两个命令的失败结果，marsdawn 0.5.1 以前'}
...
<p>行号功能从 marsdawn 0.3.0 开始提供，<code>--background</code> 从 0.5.1 开始。</p>
...
<ul>
  ...
  <li><code>--background</code> 从 marsdawn 0.5.1 开始提供。</li>
</ul>
<p>成功，退出代码 0：</p>
