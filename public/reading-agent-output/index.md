...
MarsDawn is on the [Mac App Store](https://apps.apple.com/app/id6812925073). There's also the free `marsdawn` command-line tool:

```
brew install redtear1115/tap/marsdawn
```

It exports Markdown to PDF without the app, and `marsdawn open` lets your agent open files in MarsDawn for you.
